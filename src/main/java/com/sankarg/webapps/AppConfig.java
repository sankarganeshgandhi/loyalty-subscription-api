...
public final class AppConfig {
    ...
    public final static String APPLICATION_NAME = "Loyalty-Subscription-API";
    public final static String ENV_VAR_PORT = "PORT";
    public final static String ENV_DS_URI = "LOYALTY_SUBS_API_DS_URI";
    public final static String ENV_DS_USER = "LOYALTY_SUBS_API_DS_USERNAME";
    public final static String ENV_DS_PWD = "LOYALTY_SUBS_API_DS_USERPWD";
